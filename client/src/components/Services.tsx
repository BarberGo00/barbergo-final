  ...
  const services = [
    {
      id: 1,
      title: "Corte",
      description: "Do clássico ao moderno, o corte ideal para o seu estilo.",
      price: "",
      icon: Scissors,
    },
    {
      id: 2,
      title: "Barba",
      description: "Modelagem e alinhamento da barba com precisão profissional.",
      price: "",
      icon: Sparkles,
    },
    {
      ...
      description: "Corte e Barba. O combo essencial para um visual certeiro.",
      price: "",
      icon: Scissors,
      featured: true,
    },
